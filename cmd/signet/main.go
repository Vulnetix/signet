...
func main() {
	...
	provider := flag.String("provider", "", "provider: openai, anthropic, cloudflare-workers-ai, cloudflare-ai-gateway, openrouter, google-gemini, ollama, llama, github-copilot, huggingface, or a custom name from settings.json")
