...
var tips = []string{
	...
	"f1 opens the screen switcher; one letter jumps to any screen",
	"/agents shows running agents, their profiles and the audit trail",
	"enter on a subagent in f8 follows its thread; esc returns to main",
