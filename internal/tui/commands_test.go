...
func TestRegistryNames(t *testing.T) {
	...
	want := []string{"add-dir", "agent", "agents", "budgets", "clear", "compact", "execute", "exit", "export", "help", "lsp", "mode", "model", "new", "permissions", "process", "processes", "profile", "prompts", "providers", "quit", "refine", "rename", "resume", "settings", "todos", "vulnetix", "yolo"}
