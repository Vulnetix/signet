...
func TestRegistryNames(t *testing.T) {
	...
	want := []string{"add-dir", "agent", "agents", "clear", "compact", "execute", "exit", "help", "lsp", "mode", "model", "new", "permissions", "process", "processes", "profile", "prompts", "providers", "quit", "refine", "rename", "resume", "settings", "todos", "vulnetix", "yolo"}
