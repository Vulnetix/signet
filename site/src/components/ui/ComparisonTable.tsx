...
const ROWS: Row[] = [
  ...
  {
    feature: 'classifier models embedded in the binary (no API key, no download)',
    signet: 'internal/mlclassify · tools/modelprep',
    signetCell: 'yes',
    claude: 'no',
    codex: 'no',
    cursor: 'no',
  ...
  {
    feature: 'first-run directory gated on explicit trust',
    signet: 'internal/trustgate · e2e',
    signetCell: 'yes',
    claude: 'yes',
    codex: 'unknown',
    cursor: 'unknown',
  ...
  {
    feature: 'supervised process library with an attempt-capped recovery subagent',
    signet: 'internal/bgproc · internal/processlib',
    signetCell: 'yes',
    claude: 'no',
    codex: 'no',
    cursor: 'no',
